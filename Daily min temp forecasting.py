...
class TimeSeriesAnalysis:
    ...
    def train_test_split(self):
        ...
        self.y_train = self.df[self.df.index <= pd.to_datetime('1987-01')]
    ...
    def fit(self):
        ...
        self.y_train = self.ts_df[self.ts_df.index < pd.to_datetime('1987-01')]
        
        self.y_test = self.ts_df[self.ts_df.index > pd.to_datetime('1987-01')]
       
        self.forecast = self.forecast[self.forecast.index > pd.to_datetime('1987-01')]
